...
class Player(Agent):
    ...
    def update(self):
        ...
        # Draw a rectangle centered on the agent's position
        rect_width = radius * 2
        rect_height = radius * 2
        rect = pg.Rect(x - radius, y - radius, rect_width, rect_height)
        pg.draw.rect(screen, (255, 255, 255), rect, 1)  # Draw a white rectangle with a line thickness of 1
...
if __name__=='__main__':        
    ...
    Simulation(config).spawn_agent(Player, images=["examples/images/red.png"]).batch_spawn_agents(1000,Proxyman,images=["examples/images/white.png","examples/images/green.png"]).run()
